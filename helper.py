...
class Helper:
    def __init__(self, current_time, params, name, device="cuda", centralized_attack=False, adversary_idxs=[], total_poisoned_batch=3):
        ...
        self.total_poisoned_batch = total_poisoned_batch
